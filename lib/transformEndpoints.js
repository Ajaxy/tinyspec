...
function handleCrudl(line) {
    ...
    const modelName = match[5] || _.upperFirst(_.camelCase(keyName));
    ...
    const members = getCrudlMembers(`${path}${group}`, keyName, keyNamePlural, entity, entityPlural, modelName, prefix);
